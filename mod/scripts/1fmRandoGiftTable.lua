...
local gift_location_ids = {
    ...
    [4] = {
        ...
        [0x0E] = -1,      -- Wonderland Lotus Forest Yellow Potion Flower in Center Alcove
        [0x0F] = -1,      -- Wonderland Lotus Forest Yellow Potion Flower via Painting
        [0x10] = -1,      -- Wonderland Lotus Forest Yellow Elixir Flower via Painting
        [0x11] = -1,      -- Wonderland Lotus Forest Red Ether Flower Across from Queen's Castle
        [0x12] = -1,      -- Wonderland Lotus Forest Red Hi-Potion Flower via Lily Pads
